...
export const letters = [
  // Week 8: Abraham Lincoln (First Inauguration)
  {
    id: 'week-8-lincoln',
    week: 8,
...
Your friend,`,
    historicalContext: {
      ...
      keyFacts: [
        ...
        "Seward sent Lincoln six pages of suggested revisions to the inaugural address, warning the original draft was too provocative — Lincoln rewrote Seward's flat closing into 'We are not enemies, but friends. We must not be enemies,' one of the most quoted lines in any inaugural address in American history",
        "Seward's fear that Virginia and Maryland would both secede proved only half right: Virginia left the Union on April 17, 1861 — six weeks after the inaugural, triggered by Fort Sumter, not the speech. Maryland never seceded; Lincoln suspended habeas corpus and had pro-Confederate members of its legislature arrested to keep it in the Union"
      ],
  ...
  // Week 16: Rutherford B. Hayes (Disputed Election)
  {
    id: 'week-16-hayes',
    week: 16,
...
Your friend,`,
    historicalContext: {
      background: "The 1876 election had the highest voter turnout in American history — 82.6% of eligible voters — yet neither Hayes nor Tilden made a single public campaign appearance. All speaking and rallying was done by surrogates. The joint session of Congress completed its count at 4:11 AM on March 2, 1877, just two days before the scheduled inauguration. Because March 4 fell on a Sunday, Hayes took a private oath at the White House on Saturday, March 3, with the public ceremony on Monday, March 5.",
      keyFacts: [
        "Tilden's 50.9% of the popular vote remains the largest share ever received by a losing presidential candidate — he is the only person in American history to win an outright majority of the popular vote and not become president",
        "The deal Hayes references was brokered at the Wormley Hotel in Washington, owned by James Wormley, one of the wealthiest Black entrepreneurs in America — the agreement to abandon Black citizens in the South was literally negotiated in a Black man's hotel",
        "Republican 'visiting statesmen' flooded into Florida, Louisiana, and South Carolina to influence the returning boards that certified each state's results — in Louisiana alone, the board threw out over 13,350 Democratic votes, 85% of all discarded ballots, to manufacture a Hayes majority",
        "Democrats printed ballots with Abraham Lincoln's image prominently displayed over the names of Democratic candidates to confuse illiterate voters; Republicans countered with 'little jokers' — tiny hidden Republican tickets tucked inside regular ballots",
        "Paramilitary groups including the Red Shirts and the White League used the 'Mississippi Plan' to violently suppress Black and Republican voters across the South — attacking organizers, disrupting rallies, and threatening retaliation against anyone who voted Republican",
        "There were zero campaign finance laws in 1876 — no disclosure requirements, no donation limits, no spending caps. Wealthy industrialists bankrolled both parties directly, often in explicit exchange for government appointments and contracts. The first federal campaign finance law wouldn't pass until 1907"
      ],
  ...
  // Week 7: Andrew Johnson (Impeachment)
  {
    id: 'week-7-ajohnson',
    week: 7,
